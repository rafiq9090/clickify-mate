            ...
            <div class="bg-surface/40 p-10 rounded-[3rem] border border-white/10 shadow-2xl space-y-8">
                ...
                <div class="space-y-6">
                    <div class="space-y-2">
                        ...
                        <input v-model="settings.site_name" class="w-full bg-white/5 px-6 py-4 rounded-2xl text-sm font-bold border border-white/10 focus:ring-4 ring-primary/10 transition-all outline-none text-white" placeholder="PaperSnapPro" />
                    </div>
