  ...
  <div class="error-page min-h-screen bg-surface flex flex-col items-center justify-center p-6 text-center overflow-hidden relative">
    ...
    <div class="relative z-10 space-y-12 max-w-2xl">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8">
        ...
        <NuxtLink to="/tools" class="w-full sm:w-auto px-10 py-5 bg-white border border-outline-variant/20 text-on-surface rounded-2xl font-black text-xs uppercase tracking-widest hover:bg-surface-container transition-all">
          Browse Toolkit
        </NuxtLink>
      </div>
    </div>
...
useHead({
  title: `${props.error.statusCode} Error - PaperSnapPro`,
  meta: [
